    ...
    <div>
      ...
      <input
        ...
        style={{
          ...
          background: '#F8FAFC',
          border: `1px solid ${focused ? 'rgba(0,208,130,0.45)' : '#E2E8F0'}`,
          borderRadius: 8, padding: '7px 10px',
          fontSize: 12, color: 'var(--text-primary)', outline: 'none',
          boxShadow: focused ? '0 0 0 0 rgba(0,0,0,0)' : 'none',
  ...
  return (
    <button
      ...
      style={{
        ...
        padding: '9px 14px',
        background: selected ? 'rgba(0,208,130,0.08)' : hov ? '#F8FAFC' : 'transparent',
    ...
    >
      <span style={{
        ...
        background: selected ? '#10B981' : '#CBD5E1',
        boxShadow: selected ? '0 0 0 rgba(0,0,0,0)' : 'none',
  ...
  return (
    <div ref={wrapRef} style={{ position: 'relative' }}>
      <button
        ...
        style={{
          width: '100%', boxSizing: 'border-box',
          background: open ? 'rgba(0,208,130,0.04)' : '#F8FAFC',
          border: `1px solid ${open ? 'rgba(0,208,130,0.5)' : '#E2E8F0'}`,
          borderRadius: 8, padding: '8px 12px',
          display: 'flex', justifyContent: 'space-between', alignItems: 'center',
          cursor: 'pointer',
          color: selected ? 'var(--text-primary)' : 'var(--text-muted)',
          fontSize: 12.5, fontFamily: 'var(--font-ui)',
          boxShadow: open ? '0 0 0 0 rgba(0,0,0,0)' : 'none',
      ...
      {open && (
        <div style={{
          ...
          boxShadow: '0 8px 32px rgba(15,23,42,0.12), 0 0 0 1px rgba(0,0,0,0.04)',
          ...
          {value && (
            <button
              ...
              style={{
                ...
                color: '#F43F5E', fontFamily: 'var(--font-ui)',
              }}
            >
        ...
        <div style={{ padding: '12px 26px 24px', display: 'flex', gap: 10 }}>
          ...
          <button
            ...
            style={{
              ...
              background: canSave ? 'rgba(56,189,248,0.12)' : '#F8FAFC',
              border: `1px solid ${canSave ? 'rgba(56,189,248,0.38)' : '#E2E8F0'}`,
          ...
          <div>
            <label style={{
              ...
              <span style={{
                ...
                color: parallelCalls > 1 ? '#10B981' : 'var(--text-secondary)',
          ...
          <button
            ...
            style={{
              ...
              background: canStart
                ...
                : '#F8FAFC',
              border: `1px solid ${canStart ? 'rgba(0,208,130,0.45)' : '#E2E8F0'}`,
              color: canStart ? '#10B981' : 'var(--text-muted)',
              fontSize: 13, fontWeight: 600,
              cursor: canStart ? 'pointer' : 'not-allowed',
              boxShadow: canStart ? '0 0 0 rgba(0,0,0,0)' : 'none',
              transition: 'all 0.2s',
            }}
          >
...
function ManualAddPanel({ onAdd, nextGroup, agentOptions }: {
  ...
  return (
    <div style={{
      background: '#FFFFFF',
      border: '1px solid #E2E8F0', borderRadius: 16, padding: '18px 20px',
      position: 'relative',
    }}>
      <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        <button
          ...
          style={{
            ...
            background: canAdd ? 'rgba(0,208,130,0.1)' : '#F8FAFC',
            border: `1px solid ${canAdd ? 'rgba(0,208,130,0.35)' : '#E2E8F0'}`,
            color: canAdd ? '#10B981' : 'var(--text-muted)',
    ...
    <div style={{
        ...
        <div>
          ...
          <input
            ...
            style={{
              width: '100%', boxSizing: 'border-box',
              background: '#F8FAFC',
              border: `1px solid ${csvGroup ? 'rgba(56,189,248,0.4)' : '#E2E8F0'}`,
              borderRadius: 8, padding: '7px 10px',
              fontSize: 12, color: 'var(--text-primary)', outline: 'none',
      ...
      {preview.length === 0 ? (
        <div
          ...
          style={{
            border: `2px dashed ${dragging ? 'rgba(56,189,248,0.5)' : '#E2E8F0'}`,
            borderRadius: 12, padding: '20px 16px', textAlign: 'center', cursor: 'pointer',
            background: dragging ? 'rgba(56,189,248,0.04)' : '#FAFAFA',
            transition: 'all 0.2s',
          }}
        >
        ...
        <div>
          <div style={{
            ...
            background: 'rgba(0,208,130,0.06)', border: '1px solid #CBD5E1',
          }}>
            <span style={{ fontSize: 16 }}>✓</span>
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 12, fontWeight: 600, color: '#10B981' }}>{fileName}</div>
              <div style={{ fontSize: 10.5, color: 'var(--text-muted)' }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <button onClick={reset} style={{
              flex: 1, padding: '8px', borderRadius: 8, background: '#F8FAFC',
              border: '1px solid #E2E8F0', color: 'var(--text-muted)', fontSize: 11.5, cursor: 'pointer',
            }}>Discard</button>
    ...
    <div
      ...
      style={{
        ...
        background: confirming
          ? 'rgba(244,63,94,0.04)'
          : hov ? 'rgba(16,185,129,0.04)'
          : striped ? '#FAFAFA' : 'transparent',
        transition: 'background 0.12s',
      }}
    >
      {/* Normal row */}
        ...
        <div style={{ overflow: 'hidden' }}>
          {assignedAgent ? (
            <span style={{
              ...
              background: 'rgba(0,208,130,0.07)', color: '#10B981',
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: '#FAFAFA', position: 'relative', flexShrink: 0,
      }}>
        <div style={{
          position: 'absolute', top: 0, left: 0, right: 0, height: 2,
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
          ...
          <div style={{ display: 'flex', gap: 6 }}>
            <span style={{
              ...
              background: 'rgba(0,208,130,0.09)', color: '#10B981', border: '1px solid rgba(0,208,130,0.2)',
        ...
        <div style={{ position: 'relative' }}>
          ...
          <input
            ...
            style={{
              width: '100%', boxSizing: 'border-box',
              background: '#F8FAFC',
              border: `1px solid ${focused ? 'rgba(0,208,130,0.35)' : '#E2E8F0'}`,
      ...
      <div style={{ flex: 1, overflowY: 'auto', minHeight: 180, maxHeight: 420 }}>
        {contacts.length === 0 ? (
          ...
          <>
            <div style={{
              display: 'grid', gridTemplateColumns: ROW_COLS,
              padding: '7px 20px', background: '#FAFAFA',
              borderBottom: '1px solid #F1F5F9',
  ...
  return createPortal(
    ...
    >
      <div
        ...
        style={{
          background: '#F8FAFC', border: '1px solid rgba(255,77,109,0.3)',
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button
            ...
            onMouseLeave={(e) => { e.currentTarget.style.background = '#F8FAFC'; e.currentTarget.style.color = 'var(--text-muted)'; }}
          >Cancel</button>
          <button
            onClick={onConfirm}
            style={{
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: '#FFFFFF', backdropFilter: 'none',
          border: `1px solid ${hov ? `${color}28` : '#E2E8F0'}`,
          borderRadius: 16, padding: '20px 22px',
          transform: hov ? 'translateY(-2px)' : 'none',
          boxShadow: hov ? `0 8px 25px rgba(15,23,42,0.10), 0 0 0 1px ${color}10` : '0 1px 3px rgba(15,23,42,0.06)',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0, marginLeft: 10 }}>
            ...
            <button
              ...
              onMouseLeave={(e) => { e.currentTarget.style.background = '#F8FAFC'; e.currentTarget.style.color = 'var(--text-muted)'; e.currentTarget.style.borderColor = '#E2E8F0'; }}
            >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        {c.conversion_rate != null
          ? <span style={{ fontSize: 11.5, color: '#10B981', fontWeight: 600 }}>{c.conversion_rate}% conversion</span>
          : <span />}
        <div style={{ display: 'flex', gap: 6 }}>
    ...
    <div style={{ padding: '32px 36px', minHeight: '100vh', animation: 'fade-in 0.4s both' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 26 }}>
          ...
          <div style={{ display: 'flex', gap: 12, alignItems: 'center', fontSize: 13, color: 'var(--text-muted)' }}>
            ...
            {liveCount > 0 && (
              <span style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                ...
                <span style={{ color: '#10B981', fontWeight: 600 }}>{liveCount} running</span>
              </span>
            )}
            {/* Sync status pill */}
            {syncStatus !== 'idle' && (
        ...
        <button
          ...
          onMouseEnter={(e) => { e.currentTarget.style.boxShadow = '0 0 0 rgba(0,0,0,0)'; }}
      ...
      {!isLoading && campaignList.length === 0 ? (
        <div style={{
          ...
          <button onClick={() => setShowNew(true)} style={{
            ...
            padding: '10px 24px', color: '#10B981', fontSize: 13, fontWeight: 600, cursor: 'pointer',
          }}>+ New Campaign</button>
        </div>
      ) : (
        <div>
          ...
          {isLoading ? (
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: 14 }}>
              {Array.from({ length: 2 }).map((_, i) => (
                <div key={i} style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', borderRadius: 16, padding: 22, height: 148 }}>
